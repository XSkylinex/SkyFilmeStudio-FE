...
FE-15 added the i18n mechanism: `src/lib/i18n/` holds a typed catalogue of **1,104 keys in English and
Hebrew**, counted 2026-09-02 after the prop owner's name — 1,103 after two more BE-21 refusals, 1,101
that morning after the bible's subject-rules editor, 1,087 the night before, after
