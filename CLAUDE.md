...
FE-15 added the i18n mechanism: `src/lib/i18n/` holds a typed catalogue of **1,389 keys in English
and Hebrew**, counted 2026-09-02 after the score — 1,366 after the plate writes, 1,338 after the mix
panels, 1,305 after the music and opening-ending libraries, 1,261 after the music and opening-ending
libraries, 1,222 after the SFX library, 1,179 after the pronunciation writes, 1,164 after two
audio-mix refusals, 1,162 after the structure-profile form, 1,117 after the production edit form,
1,111 after the style version diff, 1,104 after the prop owner's name, 1,103 after two more BE-21
refusals, 1,101 that morning after the bible's subject-rules editor, 1,087 the night before, after
