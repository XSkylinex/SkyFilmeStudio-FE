...
FE-15 added the i18n mechanism: `src/lib/i18n/` holds a typed catalogue of **1,503 keys in English
and Hebrew**, counted 2026-09-02 after the continuity screen — 1,469 after the production bible pin,
1,464 after the music candidates, 1,414 after the shot effects editor, 1,389 after the score, 1,366
after the plate writes, 1,338 after the mix panels, 1,305 after the music and opening-ending
