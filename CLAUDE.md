...
FE-15 added the i18n mechanism: `src/lib/i18n/` holds a typed catalogue of **986 keys in English and
Hebrew**, counted 2026-09-01 after FE-13 and the four BE-21 refusals absorbed the same evening — 109 when FE-15 closed, then the system screen, the
