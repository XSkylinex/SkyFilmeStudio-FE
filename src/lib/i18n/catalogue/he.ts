...
export const HE_CATALOGUE: Record<TranslationKey, string> = {
  ...
  'error.KEYFRAME_REQUIREMENT_DERIVED':
    'האם השוט הזה זקוק לקיפריים נגזר ממה שנמצא בו: שוט שנושא סובייקט קנוני מחייב אחד, והתשובה הזו אינה ניתנת לעריכה ידנית. אם השוט הזה רשאי לוותר על השער, תעדו ויתור עם סיבה — עריכה תמחק את השאלה במקום לענות עליה.',
  ...
  'productions.create.blocked.description':
    'כל הפקה מוצמדת לגרסת סגנון, ולפרויקט הזה אין אף אחת. ספריית הסגנונות יודעת לאשר סגנון אך עדיין לא ליצור אחד, ולכן זה נעשה דרך ה-orchestrator.',
  ...
  'bible.empty.description':
    'ביבל מתעד מול מה הפקה מתכננת — העולם, הדמויות שבו והצליל שלו. לפרויקט הזה לא תועד דבר, ואין עדיין דרך להתחיל ביבל מהמסך הזה.',
  ...
  'bible.gaps.subjectRules':
    'בלוק של דמות מזוהה לפי המזהה שלו בלבד, כי הביבל אינו נושא לו שם והמסך הזה אינו מושיט יד לפיצ׳ר אחר כדי למצוא אחד.',
  'bible.gaps.editing':
    'יצירת טיוטה ועריכה שלה הן שתיהן פעולות אמיתיות באורקסטרטור, ואף אחת מהן אינה מוצעת כאן. המסך הזה קורא ביבל ומפרסם אותו.',
