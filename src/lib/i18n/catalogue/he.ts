...
export const HE_CATALOGUE: Record<TranslationKey, string> = {
  ...
  'error.STYLE_PROFILE_IMMUTABLE':
    'גרסת פרופיל הסגנון הזו אושרה, ולכן לא ניתן עוד לערוך אותה במקום. הפקה שכבר נצמדה אליה לא אמורה להשתנות תחתיה — שינוי יוצר גרסה חדשה במקום זאת.',
  'error.STYLE_VERSION_CONFLICT':
    'פרופיל הסגנון הזה התקדם בזמן שהשינוי נעשה, ולכן הגרסה שעליה הוא התבסס אינה עוד הנוכחית. יש לטעון מחדש את הפרופיל ולבצע את השינוי שוב, כדי שהגרסה החדשה תיבנה על מה שקיים בפועל.',
  'error.network':
