...
export const HE_CATALOGUE: Record<TranslationKey, string> = {
  ...
  'plates.heading': 'פלטות',
  'plates.add': 'הוספת פלטה',
  'plates.add.heading': 'פלטה חדשה',
  'plates.edit': 'עריכה',
  'plates.edit.heading': 'עריכת הפלטה הזו',
  'plates.edit.context': 'פלטת {kind}',
  'plates.field.kind': 'סוג',
  'plates.field.kind.hint':
    'באותיות גדולות עם קווים תחתונים. ארבעת הסוגים שהמתזמר מציע מופיעים ברשימה; סוג משלכם תקף באותה מידה.',
  'plates.field.anchor': 'מעוגנת אל',
  'plates.field.anchor.hint':
    'פלטה מצביעה על דבר אחד בדיוק. שינוי סוג הדבר שהיא מצביעה עליו נשלח כשינוי אחד, מפני שניקוי עוגן אחד לפני קביעת האחר נדחה.',
  'plates.anchor.SOURCE_ASSET': 'נכס מקור',
  'plates.anchor.ARTIFACT': 'ארטיפקט',
  'plates.field.sourceAsset': 'נכס מקור',
  'plates.field.sourceAsset.none': 'בחרו נכס מקור',
  'plates.field.sourceAsset.unreadable':
    'לא ניתן היה לקרוא את נכסי הפרויקט, ולכן אי אפשר לבחור כאן אף אחד.',
  'plates.field.artifactId': 'מזהה ארטיפקט',
  'plates.field.artifactId.hint':
    'מוקלד ולא נבחר: שום דבר במתזמר אינו מציג רשימת ארטיפקטים, ולכן מזהה הוא הדרך היחידה לנקוב באחד.',
  'plates.card.approved': 'מאושרת',
  'plates.card.draft': 'טיוטה',
  'plates.card.anchor.sourceAsset': 'נכס מקור:',
  'plates.card.anchor.artifact': 'ארטיפקט:',
  'plates.card.artifactNoImage':
    'לפלטה המעוגנת לארטיפקט אין כאן תמונה: אין ראוט שמגיש את הבייטים של ארטיפקט.',
  'plates.card.frozen': 'פלטה מאושרת קפואה: יש להוסיף אחרת במקום לערוך אותה.',
  'plates.empty': 'למיקום הזה אין עדיין פלטות.',
  'plates.unreadable': 'לא ניתן היה לקרוא את הפלטות של המיקום הזה.',
  'plates.create.failed.title': 'הפלטה לא נוצרה',
  'plates.edit.failed.title': 'הפלטה לא שונתה',
  'plates.approveError.title': 'הפלטה לא אושרה',
  ...
  'page.music.title': 'מוזיקה',
  'page.music.description':
    'ספריית הפסקול של הפרויקט הזה: אילו קיוז קיימים, למה כל אחד משמש, ובאיזו עוצמה הדיאלוג יושב מעליו. קיו נמצא בשימוש חוזר בין הפקות במקום להתרנדר מחדש לכל אחת.',
  'music.loading': 'קורא את ספריית הפסקול…',
  'music.error.title': 'לא ניתן היה לקרוא את ספריית הפסקול',
  'music.empty.title': 'אין עדיין קיוז',
  'music.empty.description':
    'קיו מתרנדר ואז מקודם לספרייה הזו, ומשם מתחיל השימוש החוזר.',
  'music.truncated':
    'זהו העמוד הראשון בלבד של הקיוז. למתזמר יש יותר מהרשומים כאן.',
  'music.card.approved': 'מאושר',
  'music.card.draft': 'טיוטה',
  'music.card.category': 'קטגוריה:',
  'music.card.mood': 'מצב רוח:',
  'music.card.tags': 'תגיות:',
  'music.card.tags.none': 'אין',
  'music.card.duration': 'משך:',
  'music.card.tempo': 'טמפו:',
  'music.card.tempo.unknown': 'לא דווח, ומודל מקומי לרוב אינו מסוגל לכך',
  'music.card.key': 'סולם:',
  'music.card.loopable': 'ניתן ללופ:',
  'music.card.loopable.yes': 'כן',
  'music.card.loopable.no': 'לא',
  'music.card.intro': 'פתיח:',
  'music.card.outro': 'סיומת:',
  'music.card.safeLevel': 'הדיאלוג יושב מעליו ב־:',
  'music.card.safeLevel.explain':
    'זה מה שהופך את מעטפת ההנמכה לניתנת לחישוב במקום לציור ביד.',
  'music.card.origin': 'מקור:',
  'music.card.licence': 'רישיון:',
  'music.card.licence.none':
    'לא תועד, וזה מותר לפי החוזה לקיו שההתקנה הזו יצרה.',
  'music.card.path': 'קובץ:',
  'music.card.hash': 'טביעת אצבע SHA-256:',
  'music.card.frozen': 'קיו מאושר קפוא: ייתכן שהפקות כבר מולחנות איתו.',
  'music.card.context': 'הקיו {name}',
  'music.card.remove': 'הסרה',
  'music.card.removing': 'מסיר…',
  'music.card.removeContext': 'הסרת הקיו {name}',
  'music.card.remove.failed.title': 'הקיו לא הוסר',
  'music.approveError.title': 'הקיו לא אושר',
  'openingEnding.heading': 'פתיח וסיום',
  'openingEnding.explain':
    'טייטלים וקרדיטי סיום נמצאים בשימוש חוזר לאורך עונה במקום להיבנות מחדש בכל הפקה. כל אחד הוא שושלת: גרסה חדשה מיובאת לשושלת שהיא מחליפה, והגרסה המאושרת היא זו שהפקה משתמשת בה.',
  'openingEnding.loading': 'קורא את ספריית הפתיח והסיום…',
  'openingEnding.error.title': 'לא ניתן היה לקרוא את ספריית הפתיח והסיום',
  'openingEnding.empty.title': 'אין עדיין פתיח או סיום',
  'openingEnding.empty.description':
    'ייבאו אחד כדי להתחיל שושלת. גרסאות מאוחרות יותר מיובאות לאותה שושלת ולא כרשומות נפרדות.',
  'openingEnding.truncated':
    'זהו העמוד הראשון בלבד. למתזמר יש יותר מהרשומים כאן.',
  'openingEnding.lineage.versionCount': 'גרסאות: {count}',
  'openingEnding.lineage.approvedIs': 'מאושרת: v{version}',
  'openingEnding.lineage.noApproved': 'אין גרסה מאושרת',
  'openingEnding.lineage.kind': 'סוג:',
  'openingEnding.lineage.season': 'עונה:',
  'openingEnding.lineage.season.none': 'ללא תווית',
  'openingEnding.version.label': 'גרסה {version}',
  'openingEnding.version.approved': 'מאושרת',
  'openingEnding.version.context': 'גרסה {version} של {name}',
  'openingEnding.version.frame': 'פריים:',
  'openingEnding.version.frame.value':
    '{width}×{height} ב־{fps} פריימים לשנייה',
  'openingEnding.version.frame.unmeasured': 'לא נמדד',
  'openingEnding.version.duration': 'משך:',
  'openingEnding.version.audio': 'שמע:',
  'openingEnding.version.audio.value': '{sampleRate} הרץ, {channels} ערוצים',
  'openingEnding.version.path': 'קובץ:',
  'openingEnding.version.frozen':
    'גרסה מאושרת קפואה: יש לייבא את הגרסה הבאה לשושלת הזו במקום לערוך אותה.',
  'openingEnding.version.remove': 'הסרה',
  'openingEnding.version.removing': 'מסיר…',
  'openingEnding.version.removeContext': 'הסרת גרסה {version} של {name}',
  'openingEnding.version.remove.failed.title': 'הגרסה לא הוסרה',
  'openingEnding.approveError.title': 'הגרסה לא אושרה',
  'openingEnding.import.open': 'ייבוא פתיח או סיום',
  'openingEnding.import.heading': 'ייבוא פתיח או סיום',
  'openingEnding.import.sourcePath': 'נתיב לקובץ',
  'openingEnding.import.sourcePath.hint':
    'היכן הקובץ נמצא במכונה הזו. שום דבר אינו מועלה: המתזמר קורא אותו במקום שבו הוא כבר נמצא.',
  'openingEnding.import.name': 'שם',
  'openingEnding.import.kind': 'סוג',
  'openingEnding.import.kind.hint':
    'באותיות גדולות עם קווים תחתונים, למשל OPENING_VIDEO. הסוגים הם שלכם להמציא; שום דבר כאן אינו מספק רשימה.',
  'openingEnding.import.seasonLabel': 'תווית עונה',
  'openingEnding.import.seasonLabel.hint':
    'לא חובה. איך שצופה היה קורא לרצף שאליו זה שייך.',
  'openingEnding.import.lineage': 'גרסה חדשה של',
  'openingEnding.import.lineage.none': 'התחלת שושלת חדשה',
  'openingEnding.import.lineage.hint':
    'בחירת שושלת מייבאת את זה כגרסה הבאה שלה, וכך עונה מחליפה את הטייטלים שלה בלי לאבד את מה שהיה.',
  ...
  'audio.score.heading': 'הפסקול המולחן',
  'audio.score.explain':
    'קיו משויך לסצנה בידי מפקח המוזיקה, מתוך הקיוז שספריית הפסקול של הפרויקט מחזיקה. ההלחנה מחליפה את כל השיוך, ולכן היא החלטה על ההפקה ולא עריכה של סצנה אחת.',
  'audio.score.run': 'הלחנת ההפקה הזו',
  'audio.score.running': 'מלחין…',
  'audio.score.brief': 'תקציר',
  'audio.score.brief.hint':
    'לא חובה. למה הפסקול משמש, במילים שלכם, אם זהות המוזיקה שבביבל אינה מספיקה לבדה.',
  'audio.score.variety': 'החלק המרבי מההפקה שקיו אחד רשאי לכסות',
  'audio.score.variety.hint':
    'לא חובה, בין 0 ל־1. אפשר להשאיר ריק ולתת למתזמר להחליט; קבעו ערך כדי לדחות פסקול שנשען על קיו אחד.',
  'audio.score.failed.title': 'ההפקה לא הולחנה',
  'audio.score.unreadable': 'לא ניתן היה לקרוא את הפסקול המולחן.',
  'audio.score.none':
    'להפקה הזו אין עדיין פסקול מולחן. ההלחנה משייכת קיו לכל סצנה שזקוקה לאחד.',
  'audio.score.assigned': 'קיוז ששויכו: {count}',
  'audio.score.scene.heading': 'קיוז בסצנה הזו',
  ...
  'audio.score.cue.fades.value': '{fadeIn} כניסה, {fadeOut} יציאה',
  'audio.gaps.scoreEdit':
    'אי אפשר לכוונן כאן מיקום של קיו. המתזמר מפרסם ראוט שמחליף את הקיוז של סצנה במלואם וגם צורת בקשה עבורו; מה שאין לו דרך לבטא הוא הזזת קיו אחד בלי לשחזר את השאר, ולכן עורך היה צריך לבנות מחדש את הסצנה כולה מהמסך.',
  ...
  'audio.gaps.loudness':
    'העוצמה נמדדת על מיקס ההפקה ומוצגת למעלה. מה שעדיין חסר הוא אותה מדידה לכל סצנה: מיקס של סצנה אינו נושא מספרי עוצמה, ולכן רק ההפקה הגמורה ניתנת לשיפוט.',
  'audio.gaps.asr':
  ...
  'planner.summary.bibleVersion': 'גרסת הביבל שההפקה תוכננה מולה',
  'planner.summary.biblePublished': 'פורסם',
  'planner.summary.bibleUnpublished': 'לא פורסם',
