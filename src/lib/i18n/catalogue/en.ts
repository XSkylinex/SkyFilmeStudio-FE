...
export const EN_CATALOGUE = {
  ...
  'origin.CAMERA_CAPTURE': 'Camera capture',
  'origin.IMPORTED': 'Imported',
  'origin.LOCALLY_GENERATED': 'Locally generated',
  ...
  'openingEnding.heading': 'Opening and ending',
  'openingEnding.explain':
    'Titles and end credits are reused across a season rather than rebuilt per production. Each is a lineage: a new version is imported into the lineage it replaces, and the approved version is the one a production uses.',
  'openingEnding.loading': 'Reading the opening and ending library…',
  'openingEnding.error.title':
    'The opening and ending library could not be read',
  'openingEnding.empty.title': 'No opening or ending yet',
  'openingEnding.empty.description':
    'Import one to start a lineage. Later versions are imported into that lineage rather than as separate entries.',
  'openingEnding.truncated':
    'This is the first page only. The orchestrator has more than are listed here.',
  'openingEnding.lineage.versionCount': 'Versions: {count}',
  'openingEnding.lineage.approvedIs': 'Approved: v{version}',
  'openingEnding.lineage.noApproved': 'No approved version',
  'openingEnding.lineage.kind': 'Kind:',
  'openingEnding.lineage.season': 'Season:',
  'openingEnding.lineage.season.none': 'Not labelled',
  'openingEnding.version.label': 'v{version}',
  'openingEnding.version.approved': 'Approved',
  'openingEnding.version.context': 'version {version} of {name}',
  'openingEnding.version.frame': 'Frame:',
  'openingEnding.version.frame.value': '{width}×{height} at {fps} fps',
  'openingEnding.version.frame.unmeasured': 'Not measured',
  'openingEnding.version.duration': 'Duration:',
  'openingEnding.version.audio': 'Audio:',
  'openingEnding.version.audio.value': '{sampleRate} Hz, {channels} channels',
  'openingEnding.version.path': 'File:',
  'openingEnding.version.frozen':
    'An approved version is frozen: import the next version into this lineage rather than editing it.',
  'openingEnding.version.remove': 'Remove',
  'openingEnding.version.removing': 'Removing…',
  'openingEnding.version.removeContext': 'Remove version {version} of {name}',
  'openingEnding.version.remove.failed.title': 'The version was not removed',
  'openingEnding.approveError.title': 'The version was not approved',
  'openingEnding.import.open': 'Import an opening or ending',
  'openingEnding.import.heading': 'Import an opening or ending',
  'openingEnding.import.sourcePath': 'Path to the file',
  'openingEnding.import.sourcePath.hint':
    'Where the file is on this machine. Nothing is uploaded: the orchestrator reads it where it already is.',
  'openingEnding.import.name': 'Name',
  'openingEnding.import.kind': 'Kind',
  'openingEnding.import.kind.hint':
    'In capitals with underscores, such as OPENING_VIDEO. The kinds are yours to invent; nothing here ships a list.',
  'openingEnding.import.seasonLabel': 'Season label',
  'openingEnding.import.seasonLabel.hint':
    'Optional. What a viewer would call the run this belongs to.',
  'openingEnding.import.lineage': 'New version of',
  'openingEnding.import.lineage.none': 'Start a new lineage',
  'openingEnding.import.lineage.hint':
    'Choosing a lineage imports this as its next version, which is how a season replaces its titles without losing what came before.',
